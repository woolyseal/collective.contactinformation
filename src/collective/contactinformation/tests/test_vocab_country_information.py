...
class CountryInformationIntegrationTest(unittest.TestCase):
    ...
    def test_vocab_country_information(self):
        vocab_name = 'collective.contactinformation.CountryInformation'
