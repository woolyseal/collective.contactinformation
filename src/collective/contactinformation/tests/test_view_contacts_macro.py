...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_contacts_macro_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='contacts-macro'
        )
        self.assertTrue(view.__name__ == 'contacts-macro')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in contacts-macro'
        # )

    def test_contacts_macro_not_matching_interface(self):
